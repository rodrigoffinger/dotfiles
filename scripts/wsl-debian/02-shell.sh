...
ensure_line "$HOME/.zshrc" 'if command -v eza >/dev/null 2>&1; then'
...
ensure_line "$HOME/.zshrc" 'else'
ensure_line "$HOME/.zshrc" '  alias ll="ls -la"'
ensure_line "$HOME/.zshrc" '  alias lsa="ls -la"'
ensure_line "$HOME/.zshrc" 'fi'
...
ensure_line "$HOME/.bashrc" 'if command -v eza >/dev/null 2>&1; then'
...
ensure_line "$HOME/.bashrc" 'else'
ensure_line "$HOME/.bashrc" '  alias ll="ls -la"'
ensure_line "$HOME/.bashrc" '  alias lsa="ls -la"'
ensure_line "$HOME/.bashrc" 'fi'
